...
const greeting = {
  ...
  subTitle: emoji(
    "Im a passionate and detail-oriented engineer with around 3 years of experience in the automotive industry, specializing in data-driven development, machine learning, and software solutions for intelligent mobility. I focus on building scalable ML pipelines, computer vision tools, and automation frameworks that are robust, maintainable, and production-ready."
  ),
  resumeLink:
...
const skillsSection = {
  title: "What I do",
  subTitle: "EXPERIENCED SOFTWARE DEVELOPER | DATA SCIENTIST",
  skills: [
    emoji(
